                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yuancailiaoUuidNumber" id="yuancailiaoUuidNumber" placeholder="原材料编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yuancailiaoName" id="yuancailiaoName" placeholder="原材料名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="yuancailiaoTypes" id="yuancailiaoTypes" lay-filter="yuancailiaoTypes">
...
<script>
    ...
    // 当前表的字典表
        ...
        function yuancailiaoTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=yuancailiao_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            if (jquery('#yuancailiaoUuidNumber').val() != null && jquery('#yuancailiaoUuidNumber').val() != "" && jquery('#yuancailiaoUuidNumber').val() != "null" ) {
                param['yuancailiaoUuidNumber'] = jquery('#yuancailiaoUuidNumber').val();
            }
         
            if (jquery('#yuancailiaoName').val() != null && jquery('#yuancailiaoName').val() != "" && jquery('#yuancailiaoName').val() != "null" ) {
                param['yuancailiaoName'] = jquery('#yuancailiaoName').val();
            }
                         
            var yuancailiaoTypes = $("#yuancailiaoTypes").find("option:selected").val();
            if (yuancailiaoTypes != null && yuancailiaoTypes != "" && yuancailiaoTypes != "null") {
                param['yuancailiaoTypes'] = yuancailiaoTypes;
            }
                                                

            // 获取列表数据
            http.request('yuancailiao/list', 'get', param, function(res) {
