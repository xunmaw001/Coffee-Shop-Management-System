                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yuangongUuidNumber" id="yuangongUuidNumber" placeholder="员工工号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#yuangongUuidNumber').val() != null && jquery('#yuangongUuidNumber').val() != "" && jquery('#yuangongUuidNumber').val() != "null" ) {
                param['yuangongUuidNumber'] = jquery('#yuangongUuidNumber').val();
            }
