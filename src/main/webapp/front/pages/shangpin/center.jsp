                ...
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shangpinClicknum" id="shangpinClicknum"  lay-verify="required|integer"   placeholder="热度" autocomplete="off" class="layui-input">
							</div>
						</div>
