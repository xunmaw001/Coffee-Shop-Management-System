    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="shangpin.shangpinClicknum" type="text" readonly="readonly" name="shangpinClicknum" id="shangpinClicknum"   placeholder="热度" autocomplete="off" class="layui-input">
                </div>
            </div>
...
<!-- 唯一uuid -->
            ...
            <div class="layui-form-item" pane>
                <label class="layui-form-label">派送人：</label>
                <div class="layui-input-block">
                    <input <%--v-model="detail.shangpinOrderCourierName"--%> type="text" name="shangpinOrderCourierName" id="shangpinOrderCourierName" placeholder="派送人" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>

            <div class="layui-form-item" pane>
                <label class="layui-form-label">派送人手机号：</label>
                <div class="layui-input-block">
                    <input <%--v-model="detail.shangpinOrderCourierNumber"--%> type="text" name="shangpinOrderCourierNumber" id="shangpinOrderCourierNumber" placeholder="派送人手机号" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
