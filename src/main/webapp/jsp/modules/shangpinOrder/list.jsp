...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            if(item.shangpinOrderTypes == 1 && (window.sessionStorage.getItem('role') == "管理员" || window.sessionStorage.getItem('role') == "员工" )){
                //发货
                var detailListBtn = document.createElement('button');
