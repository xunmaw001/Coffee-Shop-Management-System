...
<body style="background-image:url('/kafeiguan/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>员工工号</label>
                                    <input id="yuangongUuidNumber" name="yuangongUuidNumber" class="form-control"
                                           placeholder="员工工号">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>员工姓名</label>
