...
public class YuancailiaoEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public YuancailiaoEntity() {

	}

	public YuancailiaoEntity(T t) {
		try {
    ...
    public String toString() {
        return "Yuancailiao{" +
            "id=" + id +
            ", yuancailiaoUuidNumber=" + yuancailiaoUuidNumber +
            ", yuancailiaoName=" + yuancailiaoName +
            ", yuancailiaoPhoto=" + yuancailiaoPhoto +
            ", yuancailiaoDanwei=" + yuancailiaoDanwei +
            ", yuancailiaoTypes=" + yuancailiaoTypes +
            ", yuancailiaoKucunNumber=" + yuancailiaoKucunNumber +
            ", yuancailiaoPrice=" + yuancailiaoPrice +
            ", yuancailiaoJinjiaMoney=" + yuancailiaoJinjiaMoney +
            ", yuancailiaoClicknum=" + yuancailiaoClicknum +
            ", yuancailiaoContent=" + yuancailiaoContent +
